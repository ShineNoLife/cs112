...
g++ genEdgeCase.cpp   -o genEdgeCase
g++ genNormalCase.cpp -o genNormalCase
g++ genSpecialCase.cpp -o genSpecialCase
g++ genStressCase.cpp  -o genStressCase
g++ genGPT.cpp        -o genGPT
